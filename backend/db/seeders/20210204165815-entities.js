...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Entities', [
      ...
      {title:"Lord of the Rings",                 userId: 1, pseudonymId: 1, typeId: 3, parentId: 1, order: 0, isPublished: true},
      ...
      {title:"Hobbit",                           userId: 1, pseudonymId: 1, typeId: 2, parentId: 1, order: 1, isPublished: true},
